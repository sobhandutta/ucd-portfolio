  ...
  return (
    <div className="ai-page-inner">
      <div className="ai-index-header">
        ...
        <p className="ai-index-intro">A collection of hands-on explorations into agentic systems, multi-agent orchestration, RAG pipelines, and AI-native product thinking — built from scratch, documented openly.</p>
      </div>
