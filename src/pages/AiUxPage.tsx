      ...
      <div className="ai-cowork">
        ...
        <div className="ai-cowork-list">
          {[
            ...
            { label: 'Research becomes a continuous input', val: 'Because synthesis is fast, research is no longer a phase. It becomes an always-on signal, with user interviews happening weekly and feeding directly into the next iteration rather than quarterly planning cycles.' },
