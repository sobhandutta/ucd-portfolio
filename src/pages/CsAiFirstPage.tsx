        ...
        <div className="cs-section">
          ...
          <div className="cs-img-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '24px', marginTop: '40px' }}>
            {[
              ...
              { src: 'https://sobhandutta.github.io/design-system/portfolio/story-04-close-the-loop.png', alt: 'Close the loop', title: 'Close the loop', desc: 'Every AI-initiated action should complete a feedback cycle. Operators should know what the system did, why, and what the outcome was, with no silent background changes.' },
            ].map(item => (
              <div key={item.title}>
